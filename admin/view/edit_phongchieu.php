        ...
        <form action="admin.php?contro=phongchieu&edit=<?php echo $_POST['id_edit_phongchieu']; ?>" method="post" id="edit_phongchieu_form">
                ...
                <tr>
                    <td>
                        <?php
                            ...
                            $phong = LoadPhongChieuById($_POST['id_edit_phongchieu']);
                            echo'
                                <input value="'.$phong['tenphong'].'" type="text" name="tenphong_editphongchieu" >

                            ';
                        ?>
                    </td>
                    <td>
                        <select name ="rap_editphongchieu" value ="">
                            <?php
                                require_once '../model/connect.php';
                                require_once '../model/getdata.php';
                                $O_rap = LoadRapById($phong['idrap']);

                                echo '<option class="old_option" value="'.$O_rap['id'].'">'.$O_rap['tenrap'].'</option>';
...
<button type="button" class="hangghe">A</button>
                            ...
                            echo'
                                $("#ghe1_'.$h.'").click(function (){
                                    ...
                                    $.post("view/css_addphongchieu.php", {value_ghe:value_ghe1_'.$h.'}, function(data){
                                        $("#css_for_edit_phongchieu1").html(data);
                                    });
                                    show_form_edit_rap();
                                });
                            ';
                ...
                <style id="css_for_edit_phongchieu1"></style>
                <style>
...
<button type="button" class="hangghe">B</button>
                            ...
                            echo'
                                $("#ghe2_'.$h.'").click(function (){
                                    ...
                                    $.post("view/css_addphongchieu.php", {value_ghe:value_ghe2_'.$h.'}, function(data){
                                        $("#css_for_edit_phongchieu2").html(data);
                                    });
                                    show_form_edit_rap();
                                });
                            ';
                ...
                <style id="css_for_edit_phongchieu2"></style>
                <style>
                            ...
                            echo'
                                $("#ghe3_'.$h.'").click(function (){
                                    ...
                                    $.post("view/css_addphongchieu.php", {value_ghe:value_ghe3_'.$h.'}, function(data){
                                        $("#css_for_edit_phongchieu3").html(data);
                                    });
                                    show_form_edit_rap();
                                });
                            ';
                ...
                <style id="css_for_edit_phongchieu3"></style>
                <style>
                            ...
                            echo'
                                $("#ghe4_'.$h.'").click(function (){
                                    ...
                                    $.post("view/css_addphongchieu.php", {value_ghe:value_ghe4_'.$h.'}, function(data){
                                        $("#css_for_edit_phongchieu4").html(data);
                                    });
                                    show_form_edit_rap();
                                });
                            ';
                ...
                <style id="css_for_edit_phongchieu4"></style>
                <style>
                            ...
                            echo'
                                $("#ghe5_'.$h.'").click(function (){
                                    ...
                                    $.post("view/css_addphongchieu.php", {value_ghe:value_ghe5_'.$h.'}, function(data){
                                        $("#css_for_edit_phongchieu5").html(data);
                                    });
                                    show_form_edit_rap();
                                });
                            ';
                ...
                <style id="css_for_edit_phongchieu5"></style>
                <style>
                    #ghe5_1:hover {background: #ffea50 ;}

                    #ghe5_2:hover {background: #ffea50 ;}
                    #ghe5_2:hover ~ #ghe5_1 {background: #ffea50 ;}
                            ...
                            echo'
                                $("#ghe6_'.$h.'").click(function (){
                                    ...
                                    $.post("view/css_addphongchieu.php", {value_ghe:value_ghe6_'.$h.'}, function(data){
                                        $("#css_for_edit_phongchieu6").html(data);
                                    });
                                    show_form_edit_rap();
                                });
                            ';
                ...
                <style id="css_for_edit_phongchieu6"></style>
                <style>
                    #ghe6_1:hover {background: #ffea50 ;}

                    #ghe6_2:hover {background: #ffea50 ;}
                    #ghe6_2:hover ~ #ghe6_1 {background: #ffea50 ;}
                            ...
                            echo'
                                $("#ghe7_'.$h.'").click(function (){
                                    ...
                                    $.post("view/css_addphongchieu.php", {value_ghe:value_ghe7_'.$h.'}, function(data){
                                        $("#css_for_edit_phongchieu7").html(data);
                                    });
                                    show_form_edit_rap();
                                });
                            ';
                ...
                <style id="css_for_edit_phongchieu7"></style>
                <style>
                    #ghe7_1:hover {background: #ffea50 ;}

                    #ghe7_2:hover {background: #ffea50 ;}
                    #ghe7_2:hover ~ #ghe7_1 {background: #ffea50 ;}
                            ...
                            echo'
                                $("#ghe8_'.$h.'").click(function (){
                                    ...
                                    $.post("view/css_addphongchieu.php", {value_ghe:value_ghe8_'.$h.'}, function(data){
                                        $("#css_for_edit_phongchieu8").html(data);
                                    });
                                    show_form_edit_rap();
                                });
                            ';
                ...
                <style id="css_for_edit_phongchieu8"></style>
                <style>
                    #ghe8_1:hover {background: #ffea50 ;}

                    #ghe8_2:hover {background: #ffea50 ;}
                    #ghe8_2:hover ~ #ghe8_1 {background: #ffea50 ;}
                            ...
                            echo'
                                $("#ghe9_'.$h.'").click(function (){
                                    ...
                                    $.post("view/css_addphongchieu.php", {value_ghe:value_ghe9_'.$h.'}, function(data){
                                        $("#css_for_edit_phongchieu9").html(data);
                                    });
                                    show_form_edit_rap();
                                });
                            ';
                ...
                <style id="css_for_edit_phongchieu9"></style>
                <style>
                    #ghe9_1:hover {background: #ffea50 ;}

                    #ghe9_2:hover {background: #ffea50 ;}
                    #ghe9_2:hover ~ #ghe9_1 {background: #ffea50 ;}
                            ...
                            echo'
                                $("#ghe10_'.$h.'").click(function (){
                                    ...
                                    $.post("view/css_addphongchieu.php", {value_ghe:value_ghe10_'.$h.'}, function(data){
                                        $("#css_for_edit_phongchieu10").html(data);
                                    });
                                    show_form_edit_rap();
                                });
                            ';
                ...
                <style id="css_for_edit_phongchieu10"></style>
                <style>
                    #ghe10_1:hover {background: #ffea50 ;}

                    #ghe10_2:hover {background: #ffea50 ;}
                    #ghe10_2:hover ~ #ghe10_1 {background: #ffea50 ;}
                            ...
                            echo'
                                $("#ghe11_'.$h.'").click(function (){
                                    ...
                                    $.post("view/css_addphongchieu.php", {value_ghe:value_ghe11_'.$h.'}, function(data){
                                        $("#css_for_edit_phongchieu11").html(data);
                                    });
                                    show_form_edit_rap();
                                });
                            ';
                ...
                <style id="css_for_edit_phongchieu11"></style>
                <style>
                    #ghe11_1:hover {background: #ffea50 ;}

                    #ghe11_2:hover {background: #ffea50 ;}
                    #ghe11_2:hover ~ #ghe11_1 {background: #ffea50 ;}
                            ...
                            echo'
                                $("#ghe12_'.$h.'").click(function (){
                                    ...
                                    $.post("view/css_addphongchieu.php", {value_ghe:value_ghe12_'.$h.'}, function(data){
                                        $("#css_for_edit_phongchieu12").html(data);
                                    });
                                    show_form_edit_rap();
                                });
                            ';
                ...
                <style id="css_for_edit_phongchieu12"></style>
                <style>
                    #ghe12_1:hover {background: #ffea50 ;}

                    #ghe12_2:hover {background: #ffea50 ;}
                    #ghe12_2:hover ~ #ghe12_1 {background: #ffea50 ;}
            ...
            <button type="submit" form="edit_phongchieu_form" name="submit_add_phongchieu" class="submit_add">
                <i class="fas fa-edit"></i>
                <span>Edit</span>
            </button>
            <button type="button" onclick="hide_form_edit_phongchieu();discard_add();" class="discard_add" id="discard_edit_but" value="1">
...
<script>   
    function discard_add() {
        ...
        <!-- SHOW SO DO GHE TRONG PHONG  -->
        <script>
           
        <?php
            require_once '../model/connect.php';
            require_once '../model/getdata.php';
            $hangghe= LoadHanggheByIdphong($_POST['id_edit_phongchieu']);
            $index_hang = 1 ;
            $index_ghe = 0;
            $sum_seat = 0;
            $old_sum = 0;
            foreach ($hangghe as $hangG) {
                
                $LastSeat = LoadLastGheInHangghe($hangG['id']);
                $index_ghe = $LastSeat['ghe']  - $old_sum;
               
               
                echo ' $(document).ready(function(){
                $(\'#ghe'.$index_hang.'_'.$index_ghe.'\').trigger(\'click\');
            }); 
            $(document).ready(function(){
                $(\'#radio_ghe'.$index_hang.'_'.$index_ghe.'\').trigger(\'click\');
            }); 
                ';

                $index_hang ++;
                $old_sum = $old_sum + $index_ghe;
            }
 ...
 <!-- CSS DISCARD AND REDO EDIT -->
 <script>
                    $(document).ready(function() {
                        $("#discard_edit_but").click(function (){
                                ...
                                $("#redo_add_but").click(function (){
                                    ...
                                    $.post("view/css_discard_addphongchieu.php", {reset_seat:value_redo}, function(data){
                                        <?php
                                            for ($w=1; $w <=12 ; $w++) { 
                                                echo'
                                                $("#css_for_edit_phongchieu'.$w.'").html(data);
                                                ';
                                            }    
                                        ?>
                                    });
